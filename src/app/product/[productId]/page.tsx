                ...
                <div className="lg:max-w-lg lg:self-end">
                        ...
                        {BREADCRUMBS.map((breadcrumbs , i ) => (
                            <li key={breadcrumbs.href}>
                                <div className="flex items-center text-sm ">
                                    <Link href={breadcrumbs.href} className="font-medium text-sm text-muted-foreground hover:text-gray-900">
                                        {breadcrumbs.name}
                                    </Link>
                    ...
                    <section className="mt-4">
                        ...
                        <div className="mt-6 flex items-center ">
                           <Check aria-hidden="true" className="h-5 w-5 flex-shink-0 text-green-500"/> 
                    ...
                    <div>
                        ...
                        <div className="mt-6 text-center">
                                <div className="group inline-flex text-sm text-medium">
                                    ...
                                    <span className="text-muted-foreground hover:text-gray-700">30 Days Return Guarantee</span>
                                </div>
                        </div>
                    </div>
                </div>
