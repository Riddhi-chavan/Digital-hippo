...
var next_utlis_1 = require("./next-utlis");
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                cartRouter.get("/", function (req, res) {
                    ...
                    var parseedUrl = (0, url_1.parse)(req.url, true);
                    return next_utlis_1.nextApp.render(req, res, "/cart", parseedUrl.query);
                });
                ...
                app.use(function (req, res) { return (0, next_utlis_1.nextHandler)(req, res); });
                next_utlis_1.nextApp.prepare().then(function () {
