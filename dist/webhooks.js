...
var stripeWebhookHandler = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var webhookRequest, body, signature, event, session, payload, users, user, orders, order, mailOptions, info, error_1;
    var _a, _b;
        ...
        switch (_c.label) {
            case 0:
                ...
                try {
                    ...
                    return [2 /*return*/, res.status(400).send("Webhook Error: ".concat(err instanceof Error
                            ? err.message
                            : 'Unknown Error'))];
                }
