...
var yourOwnAndPurchased = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var user, products, ownProductFileIds, orders, purchaseProductFiledIds;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    orders = (_b.sent()).docs;
                    purchaseProductFiledIds = orders.map(function (order) {
                    ...
                    return [2 /*return*/, {
                            id: {
                                in: __spreadArray(__spreadArray([], ownProductFileIds, true), purchaseProductFiledIds, true)
                            }
                        }];
            }
        });
